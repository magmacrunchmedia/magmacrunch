...
from magmacrunch.engine.scene import Scene, SceneStack
...
def test_op_from_key_handler_lands_before_next_render():
    # Key events arrive between frames; the queued push must apply at the next
    # update — i.e. before that frame renders.
    log = []
    stack = SceneStack()
