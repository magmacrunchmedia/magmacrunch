...
pytest.importorskip(
    "textual", reason='needs textual: pip install -e ".[dev]"'
)

from magmacrunch.engine.arcade import ArcadeGame, GameInfo, Host  # noqa: E402
...
def test_a_host_exposes_a_renderer_and_an_input_source(host):
    from magmacrunch.engine.render.abstract import Renderer, UISurface
